...
import com.sunatomsystems.ajatto.services.ProdutoServices;
...
public class ProdutoResources {
	...
	public ResponseEntity<ProdutoModel> findById(@PathVariable Long id){
			ProdutoModel obj = service.findById(id);
				return ResponseEntity.ok().body(obj);
	}	
	
	@PostMapping
	public ResponseEntity<ProdutoModel> insert(@RequestBody ProdutoModel obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ProdutoModel> update(@PathVariable Long id, @RequestBody ProdutoModel obj){
